...
int make_task_desc(SubgraphDefinition& sd, Processor proc, int task_id, void* args, size_t args_size) {
...
public:
    ...
    struct WriterTaskArgs {
        WriterTaskArgs(RegionInstance inst, IndexSpace<1> is, int level, SimpleTasksTest* test) : inst(inst), is(is), level(level) {}
        RegionInstance inst;
        IndexSpace<1> is;
        int level;
    };

    static void writer_task(const void* args, size_t arglen, const void* userdata, size_t userlen, Processor p) {
    ...
    struct ReaderTaskArgs {
        ReaderTaskArgs(RegionInstance inst, IndexSpace<1> is, int level, SimpleTasksTest* test) : inst(inst), is(is), level(level), test(test) {}
        RegionInstance inst;
        IndexSpace<1> is;
        int level;
    ...
    static void reader_task(const void* args, size_t arglen, const void* userdata, size_t userlen, Processor p) {
    ...
    void init() override {
        ...
        // each writer.
        {
            ...
            add_dependency(sd, SubgraphDefinition::OPKIND_TASK, w0_1, SubgraphDefinition::OPKIND_TASK, r0_1);
            add_dependency(sd, SubgraphDefinition::OPKIND_TASK, w0_1, SubgraphDefinition::OPKIND_TASK, r0_2);
            add_dependency(sd, SubgraphDefinition::OPKIND_TASK, w0_2, SubgraphDefinition::OPKIND_TASK, r0_1);
            add_dependency(sd, SubgraphDefinition::OPKIND_TASK, w0_2, SubgraphDefinition::OPKIND_TASK, r0_2);

            // Connect each reader at level 0 to both writers at level 1.
            add_dependency(sd, SubgraphDefinition::OPKIND_TASK, r0_1, SubgraphDefinition::OPKIND_TASK, w1_1);
            add_dependency(sd, SubgraphDefinition::OPKIND_TASK, r0_1, SubgraphDefinition::OPKIND_TASK, w1_2);
            add_dependency(sd, SubgraphDefinition::OPKIND_TASK, r0_2, SubgraphDefinition::OPKIND_TASK, w1_1);
            add_dependency(sd, SubgraphDefinition::OPKIND_TASK, r0_2, SubgraphDefinition::OPKIND_TASK, w1_2);

            // Connect both writers at level 1 to both readers at level 1.
            add_dependency(sd, SubgraphDefinition::OPKIND_TASK, w1_1, SubgraphDefinition::OPKIND_TASK, r1_1);
            add_dependency(sd, SubgraphDefinition::OPKIND_TASK, w1_1, SubgraphDefinition::OPKIND_TASK, r1_2);
            add_dependency(sd, SubgraphDefinition::OPKIND_TASK, w1_2, SubgraphDefinition::OPKIND_TASK, r1_1);
            add_dependency(sd, SubgraphDefinition::OPKIND_TASK, w1_2, SubgraphDefinition::OPKIND_TASK, r1_2);
