...
namespace Realm {
  ...
  class REALM_INTERNAL_API_EXTERNAL_LINKAGE
      ProcessorImpl { // needed by librealm_kokkos.so
  public:
    ...
    virtual void spawn_task(Processor::TaskFuncID func_id, const void *args,
                            ...
                            EventImpl::gen_t finish_gen, int priority) = 0;
  ...
  public:
    TaskRegistration(const CodeDescriptor &_codedesc, const ByteArrayRef &_userdata,
