...
namespace Realm {
  ...
  inline NodeSet::const_iterator NodeSet::begin() const { return NodeSetIterator(*this); }

  inline NodeSet::const_iterator NodeSet::end() const { return NodeSetIterator(); }
  ...
  inline bool NodeSetIterator::operator==(const NodeSetIterator &compare_to) const
  {
    if(cur_node == -1) {
      ...
      return ((nodeset == compare_to.nodeset) && (cur_node == compare_to.cur_node));
    }
  }
