...
#ifdef __ICC
#define REALM_ATTR_DEPRECATED(msg, thing) thing __attribute__((deprecated))
#define REALM_ATTR_DEPRECATED2(msg, thing1, thing2)                                      \
  thing1, thing2 __attribute__((deprecated))
#elif defined(_MSC_VER)
#define REALM_ATTR_DEPRECATED(msg, thing) __declspec(deprecated(msg)) thing
#define REALM_ATTR_DEPRECATED2(msg, thing1, thing2)                                      \
...
// TODO(cperry): replace this with realm_exports.h generated by cmake
#if defined(_MSC_VER)
#ifndef REALM_EXPORT
#ifdef realm_EXPORTS
/* We are building this library */
#define REALM_PUBLIC_API __declspec(dllexport)
#else
/* We are using this library */
#define REALM_PUBLIC_API __declspec(dllimport)
#endif
#endif
#define REALM_INTERNAL_API_EXTERNAL_LINKAGE REALM_PUBLIC_API
