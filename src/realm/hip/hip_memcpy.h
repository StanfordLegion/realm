...
#define HIP_MAX_FIELD_BYTES 64
#define HIP_MAX_BLOCKS_PER_GRID 2048
...
namespace Realm {
  namespace Hip {
    ...
    static const size_t MAX_HIP_PARAM_CONSTBANK_SIZE = 4 * 1024;

    template <size_t N, typename Offset_t = size_t,
              size_t MAX_RECTS = (MAX_HIP_PARAM_CONSTBANK_SIZE - 20) /
    ...
    template <size_t N, typename Offset_t = size_t,
              size_t MAX_RECTS = (MAX_HIP_PARAM_CONSTBANK_SIZE - 2) /
    ...
    static const size_t HIP_MAX_DIM = REALM_MAX_DIM < 3 ? REALM_MAX_DIM : 3;
  } // namespace Hip
} // namespace Realm
